...
export default {
  async fetch(request, env) {
    ...
    const payload = {
      ...
      EXPO_PUBLIC_S3_ENDPOINT: env.EXPO_PUBLIC_S3_ENDPOINT ?? "",
      EXPO_PUBLIC_S3_ACCESS_KEY: env.EXPO_PUBLIC_S3_ACCESS_KEY ?? "",
      EXPO_PUBLIC_S3_SECRET_KEY: env.EXPO_PUBLIC_S3_SECRET_KEY ?? "",
      EXPO_PUBLIC_S3_BUCKET: env.EXPO_PUBLIC_S3_BUCKET ?? "",
      EXPO_PUBLIC_S3_REGION: env.EXPO_PUBLIC_S3_REGION ?? "",
      EXPO_PUBLIC_S3_FORCE_PATH_STYLE: env.EXPO_PUBLIC_S3_FORCE_PATH_STYLE ?? "",
      EXPO_PUBLIC_CHAT_ENDPOINT: env.EXPO_PUBLIC_CHAT_ENDPOINT ?? "",
    };
